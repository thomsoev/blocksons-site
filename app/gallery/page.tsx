...
export default function GalleryPage() {
  return (
    <>
      ...
      {/* Notice about real photos */}
      <div className="bg-amber/10 border-b border-amber/20 py-4 px-4 text-center">
        <p className="text-sm text-charcoal font-medium">
          📷 Photo gallery coming soon — real job photos from Dustin will be added here.
        </p>
      </div>
